...
if (!isset($_SESSION['email'])) 
      {
        header("Location: primeros-pasos.php");
      }
else 
  if(isset($_SESSION['email']))
        {
...
<html>
  <head>
    ...
    <title>Primeros pasos - Parquí</title>
  </head>
         ...
         <br /><br />
          <br /><br /> 
            <h1><p>¡Bienvenido a Parquí!</p></h1> <p><h2>¡Nos alegra que estas acá!</h2></p>
              <p> En este aplicativo web puedes buscar parqueadero cercano con diferentes precios. </p>
                <H1>Primeros pasos...</H1>
                  <p>Ingresa tu mejor foto aquí</h3></p>
