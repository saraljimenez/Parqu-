         ...
         <br /><br />
          <br /><br /> 
           <div class="container mlogin">
              <div id="login">
                <h1>Cmbia tu contraseña </h1>
                  <form name="loginform" id="loginform" action="newpw.php" method="POST">
                    <p>
                      <label>Contraseña<br />
                      <input type="password" name="pw" placeholder="Contraseña" id="pw" class="input" value="" size="20" required/></label>
                    </p>
                     <p>
                      <label>Confirmar contraseña<br />
                      <input type="password" name="pw2" placeholder="Contraseña" id="pw" class="input" value="" size="20" required/></label>
                    </p>
                        <p class="submit">
                      <input type="submit" name="login" class="button" value="Cambiar contraseña" />
                    </p>
                </form>
              </div>
            </div>
