...
<html>
  <head>
    ...
    <title>Iniciar sesión - Parquí</title>
  </head>
         ...
         <br /><br />
          <br /><br /> 
           <div class="container mlogin">
              <div id="login">
                <h1>Inicia sesión</h1>
                  <form name="loginform" id="loginform" action="iniciar-sesion.php" method="POST">
                    <p>
                      <label for="user_login">Correo electrónico<br />
                      <input type="text" name="email" placeholder="Correo electrónico" id="correo" class="input" value="" size="20" required/></label>
                        </p>
                          <p>
                            <label for="user_pass">Contraseña<br />
                            <input type="password" placeholder="Contraseña" name="pw" id="password" class="input" value="" size="20" required/></label>
                          </p>
                        <p class="submit">
